...
trabalho1 = float(input("digite o resultado do 1 trabalho: "))
trabalho2 = float(input("digite o resultado do 2 trabalho: "))
trabalho3 = float(input("digite o resultado do 3 trabalho: "))
trabalho4 = float(input("digite o resultado do 4 trabalho: "))
